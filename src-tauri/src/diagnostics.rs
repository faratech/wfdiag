...
pub async fn run_diagnostic_task(task_id: &str) -> TaskResult {
    ...
    let native_result = tokio::task::spawn_blocking(move || {
        ...
        match task_id_owned.as_str() {
            ...
            "os_info" => diagnostics.run_wmi_query("Win32_OperatingSystem"),
            "bios" => diagnostics.run_wmi_query("Win32_BIOS"),
            "baseboard" => diagnostics.run_wmi_query("Win32_BaseBoard"),
            "processor" => diagnostics.run_wmi_query("Win32_Processor"),
            "physical_memory" => diagnostics.run_wmi_query("Win32_PhysicalMemory"),
            "device_memory" => diagnostics.run_wmi_query("Win32_DeviceMemoryAddress"),
            "dma_channel" => diagnostics.run_wmi_query("Win32_DMAChannel"),
            "irq_resource" => diagnostics.run_wmi_query("Win32_IRQResource"),
            "disk_drive" => diagnostics.run_wmi_query("Win32_DiskDrive"),
            "disk_partition" => diagnostics.run_wmi_query("Win32_DiskPartition"),
            "logical_disk" => diagnostics.get_native_disk_space(),
            "system_devices" => diagnostics.run_wmi_query("Win32_SystemDevices"),
            "network_adapter" => diagnostics.get_native_network_adapters(),
            "printer" => diagnostics.run_wmi_query("Win32_Printer"),
            "environment" => diagnostics.run_wmi_query("Win32_Environment"),
            "startup_command" => diagnostics.run_wmi_query("Win32_StartupCommand"),
            "system_driver" => diagnostics.run_wmi_query("Win32_SystemDriver"),
            ...
            "processes" => diagnostics.run_wmi_query("Win32_Process"),
