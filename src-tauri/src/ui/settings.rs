            ...
            if app.settings.ai_enabled {
                ...
                ui.horizontal(|ui| {
                    ...
                    if app.ai_status_checking {
                        ...
                        if status.available {
                            ui.label(RichText::new("✓ Available").size(11.0).color(colors::SUCCESS));
                        } else {
                            ui.label(RichText::new("✗ Not available").size(11.0).color(colors::ERROR));
                        }
                ...
                if has_key {
                    ui.label(RichText::new("✓ API key configured").size(11.0).color(colors::SUCCESS));
                } else {
