...
### **Core Capabilities**
- **48 Diagnostic Tasks** across system, hardware, storage, network, security, software, logs, graphics, drivers, performance, and debugging
...
- **34 Deterministic Issue Rules** with explicit verified, detected, and unknown outcomes
...
The registry currently contains 48 checks. `crates/wfdiag-native-diagnostics/src/catalog.rs` is the authoritative task catalog; both shells derive their category counts from that registry instead of maintaining a second list.
